...
module.exports = function (baseEndpoint) {
  return {
    ...
    _apiGet: function (path) {
      ...
      var headers = {Authentication: this.token};
    ...
    _apiPost: function (path, data) {
      var url = baseEndpoint + path;
      var headers = {Authentication: this.token};
      return axios.post(url, data, {headers: headers}).then(function (resp) {
        return resp.data;
      });
    },
    _apiPut: function (path, data) {
      var url = baseEndpoint + path;
      var headers = {Authentication: this.token};
      return axios.put(url, data, {headers: headers}).then(function (resp) {
        return resp.data;
      });
    },
